...
const pt: SiteContent = {
  ...
  projects: [
    { id: 1, title: 'Stand Expo Maputo — TechCorp', category: 'Stands', gradient: gradients.orange, wide: true },
    { id: 2, title: 'CGI de Produto — Citrinos Frescos', category: '3D', gradient: gradients.lime, image: imgLemon },
    { id: 3, title: 'Animação 3D — Mãos Robóticas', category: '3D', gradient: gradients.blue, image: imgRobotic, wide: true },
    { id: 4, title: 'Campanha Nacional — Banco Azul', category: 'Publicidade', gradient: gradients.blue },
    { id: 5, title: 'Stand 3D — Feira FACIM', category: 'Stands', gradient: gradients.rose },
    { id: 6, title: 'Hard-Surface — Equipamento Tech', category: '3D', gradient: gradients.orange, image: imgGear },
    { id: 7, title: 'Rebranding — Sabores de Moçambique', category: 'Branding', gradient: gradients.lime },
    { id: 8, title: 'Pavilhão Imersivo — EnergiaMoz', category: 'Stands', gradient: gradients.duo, wide: true },
    { id: 9, title: 'CGI de Produto — Laranjas', category: '3D', gradient: gradients.amber, image: imgOrange },
    { id: 10, title: 'Lançamento Digital — MozaPay', category: 'Digital', gradient: gradients.purple },
    { id: 11, title: 'Outdoor Interativo — Vodacom', category: 'Publicidade', gradient: gradients.amber },
    { id: 12, title: 'Social Media — Grupo Horizonte', category: 'Digital', gradient: gradients.pink },
  ],
...
const en: SiteContent = {
  ...
  projects: [
    { id: 1, title: 'Expo Maputo Stand — TechCorp', category: 'Stands', gradient: gradients.orange, wide: true },
    { id: 2, title: 'Product CGI — Fresh Citrus', category: '3D', gradient: gradients.lime, image: imgLemon },
    { id: 3, title: '3D Animation — Robotic Hands', category: '3D', gradient: gradients.blue, image: imgRobotic, wide: true },
    { id: 4, title: 'National Campaign — Banco Azul', category: 'Advertising', gradient: gradients.blue },
    { id: 5, title: '3D Stand — FACIM Fair', category: 'Stands', gradient: gradients.rose },
    { id: 6, title: 'Hard-Surface — Tech Gear', category: '3D', gradient: gradients.orange, image: imgGear },
    { id: 7, title: 'Rebranding — Sabores de Moçambique', category: 'Branding', gradient: gradients.lime },
    { id: 8, title: 'Immersive Pavilion — EnergiaMoz', category: 'Stands', gradient: gradients.duo, wide: true },
    { id: 9, title: 'Product CGI — Oranges', category: '3D', gradient: gradients.amber, image: imgOrange },
    { id: 10, title: 'Digital Launch — MozaPay', category: 'Digital', gradient: gradients.purple },
    { id: 11, title: 'Interactive Billboard — Vodacom', category: 'Advertising', gradient: gradients.amber },
    { id: 12, title: 'Social Media — Grupo Horizonte', category: 'Digital', gradient: gradients.pink },
  ],
